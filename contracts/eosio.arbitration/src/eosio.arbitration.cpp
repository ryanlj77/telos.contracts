							  ...
							  string decision_link, uint8_t decision_class)
{
	...
	check(cf.case_status < DECISION && cf.case_status > AWAITING_ARBS, "unable to accept claim while this case file is in this status");
...
{
	require_auth2("eosio.arb"_n.value, "major"_n.value);
